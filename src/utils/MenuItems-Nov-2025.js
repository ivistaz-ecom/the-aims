export const MenuItems = [
  ...
  },
  {
    ...
    links: [
      ...
      { name: "Governing Council Members", href: "/governing-council-members" },
      {
        name: "Management Council Members",
        href: "/management-council-members",
      },
      { name: "Finance Committee", href: "/finance-committee" },
      { name: "Chief Vigilance Officer", href: "/chief-vigilance-officer" },
      { name: "Controller of Examination", href: "/controller-of-examination" },
  ...
  },
  {
    title: "Academics",
    links: [
      { name: "Academic Program Details", href: "/program-overview" },
      ...
      { name: "Swayam NPTEL", href: "/swayam-nptel" },
      {
      ...
      },
      {
        ...
        href: "/aims-academic-collaborations",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    links: [
      ...
      { name: "Central Facilities", href: "/central-facilities" },
  ...
  },
  {
    ...
    links: [
      ...
      {
        name: "Centre for Student Development",
        href: "/centre-for-student-development",
      },
      {
        name: "Centre for Community Service",
        href: "/centre-for-community-service",
      },
      { name: "Centre for Consulting", href: "/centre-for-consulting" },
      {
        name: "Centre for International Liaison",
        href: "/centre-for-international-liaison",
      },
      {
  ...
  },
  {
    ...
    links: [
      { name: "Circulars and Notices", href: "/circular-and-notices" },
