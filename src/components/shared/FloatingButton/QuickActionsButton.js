...
const QuickActionsButton = () => {
    ...
    return (
        <div
            ...
            className={`fixed right-6 bottom-6 z-[9999] group transition-all duration-500 ${isVisible
        ...
        >
            ...
            <div className="relative">
                ...
                >
                    <FaPlus className={`w-5 h-5 transition-all duration-500 ${isMobile ? (isExpanded ? 'rotate-90 scale-110' : '') : 'group-hover:rotate-90 group-hover:scale-110'}`} />
                ...
                <div className={`absolute inset-0 flex items-center justify-center ${isMobile ? (isExpanded ? 'pointer-events-auto' : 'pointer-events-none') : 'pointer-events-none group-hover:pointer-events-auto group-hover:delay-300 group-hover:delay-1000'}`}>
                    ...
                    <Link
                        ...
                        ${isMobile ?
                                (isExpanded ? 'opacity-100 scale-100 translate-y-[-100px] animate-bounce' : 'opacity-0 scale-0') :
                    ...
                    <Link
                        ...
                        ${isMobile ?
                                (isExpanded ? 'opacity-100 scale-100 translate-x-[-100px] animate-bounce' : 'opacity-0 scale-0') :
                    ...
                    <div className={`absolute inset-0 transition-opacity duration-1000 ${isMobile ? (isExpanded ? 'opacity-100' : 'opacity-0') : 'opacity-0 group-hover:opacity-100'}`}>
