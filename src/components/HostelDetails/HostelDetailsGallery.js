...
const HostelDetailsGallery = () => {
  return (
    <>
      <HostelDetailsGalleryCarousel
        title="Hostel Details"
        description={`AIMS provides comfortable and secure hostel facilities to ensure a pleasant stay for students on campus. The institute has a total of four hostels -  two for boys and two for girls.  
